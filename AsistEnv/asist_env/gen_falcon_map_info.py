...
def read_json_file(difficulty):
    ...
    file_name = "room_" + difficulty + ".json"
    with open(file_name, "w") as outfile:
        json.dump(room_data, outfile, ensure_ascii=False, indent=4)

    file_name = "portal_" + difficulty + ".json"
    with open(file_name, "w") as outfile:
        json.dump(portal_data, outfile, ensure_ascii=False, indent=4)

    file_name = "victim_" + difficulty + ".json"
    with open(file_name, "w") as outfile:
        json.dump(victim_data, outfile, ensure_ascii=False, indent=4)
